                ...
                <div class="col-lg-9">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col">
                          <div class="card">
                            <div class="card-body">
                              <h5 class="card-title tt">Название</h5>
                              <p class="card-text ty"><b>Цена:</b> 15000 рублей</p>
                              <div class="ty">
    ...
    <section id="aboutus" style="margin-bottom: 3%;">
        <div class="container">
            <div class="row">
                <h1>О НАС</h1>
                <div class="col-lg-6">
                    <img src="img/4.jpg" alt="" width="600" height="500">
                </div>
                ...
                <p>Размещение базовой информации о требующих оплаты курсах, событиях, вебинарах для онлайн центров обучения - платное.</p>
                </div>
            </div>
        </div>
    </section>
