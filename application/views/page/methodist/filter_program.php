<main class="container-fluid">
	...
	<div class="container">
		<div class="row justify-content-md-center">
			<div class="col col-lg-1">
                <button class="btn btn-primary"><a href="edu_program/add_program">Добавить</a></button>
			</div>
			<div class="col-md-auto">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-auto">
								...
								<select class="form-select filter_info" id="id_focus">
							...
							<div class="col-auto">
								...
								<select class="form-select filter_info" id="id_type_ep">
									<option value="all" selected>Все</option>
							...
							<div class="col-auto">
								...
								<select class="form-select filter_info" id="id_form">
									<option value="all" selected>Все</option>
							...
							<div class="col-auto">
								...
								<select class="form-select filter_info" id="id_type_doc">
									<option value="all" selected>Все</option>
